...
from hypergraphx.viz.interactive_view.stats_view.stats_calculations import adjacency_calculations_pool
from hypergraphx.viz.interactive_view.stats_view.stats_widgets import GenericGraphWidget, MotifsWidget, \
    CentralityWidget, SimilarityWidget, DegreeWidget, WeightWidget, AdjacencyWidget
...
class HypergraphStatsWidget(QMainWindow):
    ...
    def __init__(self, controller, parent=None):
        ...
        self.degree_tab = DegreeWidget(
            hypergraph=self.controller.get_hypergraph(),
            parent=self.vertical_tab
        )
        self.node_similarity_tab = SimilarityWidget(
            hypergraph=self.controller.get_hypergraph(),
            parent=self.vertical_tab
        )
